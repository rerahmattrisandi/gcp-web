...
<div class="pt-2 pb-2 w-1/2 lg:w-1/2 md:w-2/6 sm:w-1/2 m-auto">
    ...
    <br>
    <textarea class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" rows="3" name="description" id="description" placeholder="This is a textarea placeholder"></textarea>
</div>
<div class="pt-2 pb-2 w-1/2 lg:w-1/2 md:w-2/6 sm:w-1/2 m-auto">
    <span>Image : </span>
    <br>
